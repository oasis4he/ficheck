...
<div class="body fixedExpenses">
  <div class="ficheck-section-body">
    ...
    @if(!isset($statement))
      <div class="row newItem">
          ...
          <div class="form-group col-xs-6">
              <input name="new_fixed_expense" id="new_fixed_expense" value="" class="form-control">
          </div>
      </div>
    @endif
    ...
    <div class="row valueTypeTotal planned active">
        ...
        <div class="form-group col-xs-6">
            <input name="total_fixed_expenses_planned" id="total_fixed_expenses_planned" value="" class="form-control totalInput" readonly>
        </div>
    </div>
    ...
    <div class="row valueTypeTotal actual">
        ...
        <div class="form-group col-xs-6">
            <input name="total_fixed_expenses_actual" id="total_fixed_expenses_actual" value="" class="form-control totalInput" readonly>
        </div>
    </div>
    ...
    <div class="row valueTypeTotal difference">
        ...
        <div class="form-group col-xs-6">
            <input name="total_fixed_expenses_difference" id="total_fixed_expenses_difference" value="" class="form-control totalInput" readonly>
        </div>
    </div>
